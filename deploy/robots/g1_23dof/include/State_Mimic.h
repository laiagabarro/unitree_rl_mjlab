...
public:
    ...
    void exit()
    {
        ...
        // Signal FSMState::enter() to skip interpolation: the Mimic policy already
        // drives joints to a controlled pose, so blending is unnecessary and jarring.
        FSMState::skip_next_enter_interp_ = true;
    }
