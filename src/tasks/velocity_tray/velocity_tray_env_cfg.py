  ...
  terminations = {
    ...
    "cube_fallen": TerminationTermCfg(
      ...
      params={
        ...
        "cube_names": ("cube_0", "cube_1", "cube_2", "cube_3"),
        "height_threshold": 0.1,
        # Ramps in together with cube_inside_tray_curriculum's progress
        # (same state_key as its target_reward), instead of switching on
        # for every env in the same step once the reward weight hits 1.0.
        "activation_state_key": "cube_inside_tray",
      },
    ),
  }
